...
class NumberOfNotesTest extends TestCase
{
    /**
     *  @dataProvider provideVideoGame 
     */
    public function testNumberOfNotes(VideoGame $videoGame, NumberOfRatingPerValue $expectedNumberofRatingPerValue): void
    {
    ...
    public static function provideVideoGame(): iterable
    {
        ...
        yield 'One review' => [self::createVideoGame(5), self::createExpectedState(five: 1)];
